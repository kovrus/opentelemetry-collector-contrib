...
require (
	...
	github.com/DataDog/datadog-agent/pkg/trace v0.50.0-rc.3
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.50.0-rc.3 // indirect
	github.com/DataDog/datadog-agent/pkg/proto v0.50.0-rc.3 // indirect
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.50.0-rc.3 // indirect
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.50.0-rc.3 // indirect
	github.com/DataDog/datadog-agent/pkg/util/log v0.50.0-rc.3 // indirect
	github.com/DataDog/datadog-agent/pkg/util/pointer v0.50.0-rc.3 // indirect
